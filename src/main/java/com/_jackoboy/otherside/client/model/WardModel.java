...
public class WardModel<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // Whiskers on head (flat planes at front)
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        // Jaw animation - lower jaw opens/closes
        this.lowerJaw.xRot = 0.1F + Mth.sin(ageInTicks * 0.12F) * 0.08F;
        // Upper jaw slight counter-movement
        ...
        for (int i = 0; i < 3; i++) {
            ...
            // Slight Y-rot for more organic feel
